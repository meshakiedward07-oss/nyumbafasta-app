        ...
        {localUnlocked && unlockCreatedAt && (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-3 flex items-center gap-3">
            ...
            <a
              ...
              className="flex-shrink-0 bg-green-500 text-white text-xs px-3 py-2 rounded-xl font-semibold active:scale-95 transition-transform"
            >
              Endelea →
            </a>
          </div>
