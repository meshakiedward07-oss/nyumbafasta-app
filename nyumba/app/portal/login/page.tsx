...
function PortalLoginForm() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      // Determine redirect from portal_type or user_metadata
      let dest = '/'
      ...
      <div className="flex-1 px-4 -mt-5 pb-8 max-w-sm mx-auto w-full">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-5 pt-5 pb-1">
            <h1 className="text-lg font-bold text-gray-900">Karibu Tena</h1>
            <p className="text-sm text-gray-500 mt-0.5">Ingia katika akaunti yako</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="p-5 space-y-4">
            ...
            <div className="text-right -mt-1">
              <Link href="/login" className="text-xs text-primary-500 font-medium hover:underline">
                Umesahau nenosiri?
              </Link>
            </div>
