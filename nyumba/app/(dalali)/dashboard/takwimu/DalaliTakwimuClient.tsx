            ...
            {!microsite ? (
              ...
              <>
                ...
                {account?.username && (
                  ...
                  >
                    <div>
                      <p className="text-xs font-semibold text-gray-800">Ukurasa wako wa umma</p>
          ...
          <>
            <div className="flex items-center justify-between">
              <p className="text-xs text-gray-500">
                {contacts.length > 0 ? `Wateja wa hivi karibuni (${contacts.length})` : 'Wateja'}
              </p>
              {account && account.totalContacts > 30 && (
                <span className="text-xs text-amber-600 font-medium">Inaonyesha 30 za hivi karibuni</span>
              )}
            </div>
                ...
                {fiveStar > 0 && (
                  <div className="mt-3 bg-amber-50 rounded-xl px-3 py-2 flex items-center gap-2">
                    ...
                    <p className="text-xs text-amber-700 font-medium">
                      {fiveStar} kati ya {ratingCount} wamekupa nyota 5!
                    </p>
                  </div>
                )}
              </div>
