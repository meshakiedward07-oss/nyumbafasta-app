    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="hidden lg:block p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2"><PlatformLogo platform="facebook" size={24} />Facebook Groups</h1>
              ...
              {groups.length === 0 && (
                <tr>
                  <td colSpan={8} className="text-center py-16 text-gray-400">
                    <div className="text-4xl mb-3 flex justify-center"><PlatformLogo platform="facebook" size={40} /></div>
      ...
      <div className="lg:hidden">
        ...
        <header className="bg-primary-500 px-4 py-4 sticky top-0 z-10 shadow">
          <h1 className="text-white font-bold text-lg flex items-center gap-2"><PlatformLogo platform="facebook" size={24} />Facebook Groups</h1>
        ...
        <div className="px-4 space-y-3">
          ...
          {groups.length === 0 && (
            <div className="text-center py-16">
              <div className="text-5xl mb-3 flex justify-center"><PlatformLogo platform="facebook" size={40} /></div>
